...
namespace QuantLib {
  ...
  inline LognormalCmsSpreadPricer::LognormalCmsSpreadPricer(
        const boost::shared_ptr<CmsCouponPricer> cmsPricer,
        const Handle<Quote> &correlation,
        const Handle<YieldTermStructure> &couponDiscountCurve,
  ...
  inline Real LognormalCmsSpreadPricer::integrand(const Real x) const {
  ...
  inline Real LognormalCmsSpreadPricer::integrand_normal(const Real x) const {
  ...
  inline void LognormalCmsSpreadPricer::flushCache() { cache_.clear(); }
  ...
  inline Real LognormalCmsSpreadPricer::optionletPrice(Option::Type optionType,
                                                  Real strike) const {
  ...
  inline Rate LognormalCmsSpreadPricer::swapletRate() const {
        return swapletPrice() / (coupon_->accrualPeriod() *
                                 couponDiscountCurve_->discount(paymentDate_));
    }

  inline Real LognormalCmsSpreadPricer::capletPrice(Rate effectiveCap) const {
  ...
  inline Rate LognormalCmsSpreadPricer::capletRate(Rate effectiveCap) const {
        return capletPrice(effectiveCap) /
               (coupon_->accrualPeriod() *
                couponDiscountCurve_->discount(paymentDate_));
    }

  inline Real LognormalCmsSpreadPricer::floorletPrice(Rate effectiveFloor) const {
  ...
  inline Rate LognormalCmsSpreadPricer::floorletRate(Rate effectiveFloor) const {
        return floorletPrice(effectiveFloor) /
               (coupon_->accrualPeriod() *
                couponDiscountCurve_->discount(paymentDate_));
    }

  inline Real LognormalCmsSpreadPricer::swapletPrice() const {
