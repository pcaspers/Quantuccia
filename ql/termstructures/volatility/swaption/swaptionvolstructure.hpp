...
namespace QuantLib {
    ...
    inline Time SwaptionVolatilityStructure::swapLength(const Period& p) const {
    ...
    inline Time SwaptionVolatilityStructure::swapLength(const Date& start,
                                                 const Date& end) const {
    ...
    inline void SwaptionVolatilityStructure::checkSwapTenor(const Period& swapTenor,
                                                     bool extrapolate) const {
    ...
    inline void SwaptionVolatilityStructure::checkSwapTenor(Time swapLength,
                                                     bool extrapolate) const {
