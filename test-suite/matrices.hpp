...
namespace {
    ...
    Size N;
    Matrix M1, M2, M3, M4, M5, M6, M7, I1;
    ...
    void setupMatrix() {
        ...
        I1[0][0] = 1.0;  I1[0][1] = 0.0;  I1[0][2] = 0.0;
        I1[1][0] = 0.0;  I1[1][1] = 1.0;  I1[1][2] = 0.0;
        I1[2][0] = 0.0;  I1[2][1] = 0.0;  I1[2][2] = 1.0;
...
void MatricesTest::testSVD() {
    ...
    for (Size j = 0; j < LENGTH(testMatrices); j++) {
        ...
        if (norm(U_Utranspose-I1) > tol)
            BOOST_FAIL("U not orthogonal (norm of U^T*U-I1 = "
                       << norm(U_Utranspose-I1) << ")");

        Matrix V_Vtranspose = transpose(V)*V;
        if (norm(V_Vtranspose-I1) > tol)
            BOOST_FAIL("V not orthogonal (norm of V^T*V-I1 = "
                       << norm(V_Vtranspose-I1) << ")");
...
void MatricesTest::testInverse() {
    ...
    Real tol = 1.0e-12;
    Matrix testMatrices[] = { M1, M2, I1, M5 };
...
void MatricesTest::testDeterminant() {
    ...
    Matrix testMatrices[] = {M1, M2, M5, M6, I1};
