...
namespace {
    ...
    struct SingleCase1 {
        SingleCase1(ActualActual::Convention convention,
                   const Date& start,
                   const Date& end,
                   const Date& refStart,
                   const Date& refEnd,
...
void DayCounterTest::testActualActual() {
    ...
    SingleCase1 testCases[] = {
        // first example
        SingleCase1(ActualActual::ISDA,
                   Date(1,November,2003), Date(1,May,2004),
                   0.497724380567),
        SingleCase1(ActualActual::ISMA,
                   Date(1,November,2003), Date(1,May,2004),
                   Date(1,November,2003), Date(1,May,2004),
                   0.500000000000),
        SingleCase1(ActualActual::AFB,
                   Date(1,November,2003), Date(1,May,2004),
                   0.497267759563),
    ...
    Size n = sizeof(testCases)/sizeof(SingleCase1);
    for (Size i=0; i<n; i++) {
